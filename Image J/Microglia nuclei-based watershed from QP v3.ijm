// Run macro on exported Full Classifier annotated image (i.e. with detection overlays) 
// from QuPath, manually or using batch QP script
...
// Delete overlay objects of non-microglial cells (this working depends entirely on class names in QuPath project and thus in the image)
