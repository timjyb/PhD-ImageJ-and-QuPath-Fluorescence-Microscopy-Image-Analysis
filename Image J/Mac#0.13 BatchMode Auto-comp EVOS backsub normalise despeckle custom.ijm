...
output = starting_folder+year+""+month+""+dayOfMonth+" "+hour+"-"+minute+"-"+second+" Custom comps Mac#0/";
//print(output);
...
if(process_bool){
	if(same_set){
		print(f, dayOfMonth+"/"+month+"/"+year+" \r"+hour+":"+minute+":"+second+" \r"+"Channels composited: "+chosen_ch+ "\r"+"TRANS included?: "+TRANS_bool+" \r"+"Extra image processing: \r"+"Same settings for all channels?: Yes \r"+
		...
		print(f, dayOfMonth+"/"+month+"/"+year+" \r"+hour+":"+minute+":"+second+" \r"+"Channels composited: "+chosen_ch+ "\r"+"TRANS included?: "+TRANS_bool+" \r"+"Extra image processing: \r"+"Same settings for all channels?: No \r \r"+
	...
	print(f, dayOfMonth+"/"+month+"/"+year+" \r"+hour+":"+minute+":"+second+" \r"+"Channels composited: "+chosen_ch+ "\r"+"TRANS included?: "+TRANS_bool+" \r"+"No extra image processing");
}
...
if(ElapsedMin==0){
	endmsg = "Processing Completed! "+numimgs+" images processed in "+RemainderSec+" seconds.";
}
else{
	endmsg = "Processing Completed! "+numimgs+" images processed in "+ElapsedMin+" minutes and "+RemainderSec+" seconds.";
}
print(endmsg);
beep();
